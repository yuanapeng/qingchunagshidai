...
constexpr HardwareConfig CAMERA_VERSION_CONFIG = {
    ...
    .display_backlight_pin = GPIO_NUM_NC,
    .display_mosi_pin = GPIO_NUM_NC,
    .display_clk_pin = GPIO_NUM_NC,
    .display_dc_pin = GPIO_NUM_NC,
...
constexpr HardwareConfig NON_CAMERA_VERSION_CONFIG = {
    ...
    .right_leg_pin = GPIO_NUM_14,
    .right_foot_pin = GPIO_NUM_12,
    .left_leg_pin = GPIO_NUM_13,
    .left_foot_pin = GPIO_NUM_11,
    .left_hand_pin = GPIO_NUM_20,
    .right_hand_pin = GPIO_NUM_17,
...
#define CAMERA_XCLK (GPIO_NUM_NC)
#define CAMERA_PCLK (GPIO_NUM_NC)
#define CAMERA_VSYNC (GPIO_NUM_NC)
#define CAMERA_HSYNC (GPIO_NUM_NC)
#define CAMERA_D0 (GPIO_NUM_NC)
#define CAMERA_D1 (GPIO_NUM_NC)
#define CAMERA_D2 (GPIO_NUM_NC)
#define CAMERA_D3 (GPIO_NUM_NC)
#define CAMERA_D4 (GPIO_NUM_NC)
#define CAMERA_D5 (GPIO_NUM_NC)
#define CAMERA_D6 (GPIO_NUM_NC)
#define CAMERA_D7 (GPIO_NUM_NC)
